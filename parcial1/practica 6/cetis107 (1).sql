...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 15-02-2025 a las 01:14:49
...
(11, 'Emiliano', 'Lopez Sanchez', '23325061070437', '2008-01-25', 1, 'emiliano.lopez23@cetis107.edu.mx', '6675137288');
...
--
-- Estructura de tabla para la tabla `carga_academica2`
--

CREATE TABLE `carga_academica2` (
  `id` int(11) NOT NULL,
  `materia_id2` int(11) NOT NULL,
  `alumno_id2` int(11) NOT NULL,
  `calificacion` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Volcado de datos para la tabla `carga_academica2`
--

INSERT INTO `carga_academica2` (`id`, `materia_id2`, `alumno_id2`, `calificacion`) VALUES
(1, 2, 11, 10),
(2, 3, 11, 10),
(3, 4, 11, 10),
(4, 5, 11, 0),
...
--
-- Indices de la tabla `carga_academica2`
--
ALTER TABLE `carga_academica2`
  ADD PRIMARY KEY (`id`),
  ADD KEY `materia_id2` (`materia_id2`),
  ADD KEY `alumno_id2` (`alumno_id2`);
...
ALTER TABLE `clases`
  ...
  ADD KEY `materia_id_2` (`materia_id`),
...
--
-- AUTO_INCREMENT de la tabla `carga_academica2`
--
ALTER TABLE `carga_academica2`
...
--
-- Filtros para la tabla `carga_academica2`
--
ALTER TABLE `carga_academica2`
  ADD CONSTRAINT `carga_academica2_ibfk_1` FOREIGN KEY (`materia_id2`) REFERENCES `clases` (`id`),
  ADD CONSTRAINT `carga_academica2_ibfk_2` FOREIGN KEY (`alumno_id2`) REFERENCES `alumnos` (`id`);
